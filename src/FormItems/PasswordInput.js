...
export class PasswordInput{
    ...
    set(key, value){
        ...
        switch (key){
            ...
            case "maxlength":
                ...
                break;
            case "field_size":
                const sizes = PasswordInput.fieldSizes;
    ...
    getAll(inputs = ["name", "id", "label_text", "required", "field_size", "value", "maxlength", "size", "placeholder", "disabled"]){
        let data = {};
    ...
    new({name="", id="", size=6, label_text="Поле с паролем", placeholder = "Поле с паролем", maxlength = 0, field_size = 0, required = true, disabled = false, value = ""} = {}){
        this.input = $("<input>").attr("type", "password");

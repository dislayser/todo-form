...
export class NumberInput{
    ...
    set(key, value){
        ...
        switch (key){
            ...
            case "size":
                ...
                break;
            case "field_size":
                const sizes = NumberInput.fieldSizes;
            ...
            case "required":
                ...
                this.input.attr("required", value);
                value ?
    ...
    new({name="", id="", size=6, label_text="Числовое поле", placeholder = "Числовое поле", min = null, max = null, step = null, field_size = 0, required = false, value = null, disabled = false} = {}){
        this.input = $("<input>").attr("type", "number");
